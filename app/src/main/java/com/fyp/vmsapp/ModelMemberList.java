...
public class ModelMemberList {
    ...
    public ModelMemberList(String name, String date_of_birth, String image_path, String blood_group, String age_group, String relationship, String desc, int family_member_id, int blood_group_id, int relationship_id) {
        this.name = name;
    ...
    public ModelMemberList(String name, String date_of_birth, String image_path, String blood_group, String age_group, String relationship, String desc) {
        this.name = name;
        this.date_of_birth = date_of_birth;
        this.image_path = image_path;
        this.blood_group = blood_group;
